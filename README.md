...
- **Driver della crescita**: for every year since your cashflow is complete, where the year's growth came from — what you saved (income minus spending already happened), what the market did (measured instrument by instrument, the quotes you traded counted from their trade price, the same figure as the Panoramica), the tax withheld on your sales, the mortgage principal repaid, what went into your pension funds, and what none of these explains («altre variazioni», named in the sentence only when it matters) — with the last twelve months as bars and every part in the hover; a year in which the market took is said in words, never as a share
