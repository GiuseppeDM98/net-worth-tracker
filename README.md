...
- **Patrimonio** opens with a one-sentence verdict on your portfolio — "Il portafoglio cresce." / "Il portafoglio è in calo: il mercato ha pesato." / "…le tasse sulle vendite di più." — followed by the facts in words (value, change over last month, how many instruments and accounts you hold, the single instrument that moved the most, the market-vs-your-flows split and, when you sold, the sale with its estimated tax — the same rule as the Panoramica), then a grid of tiles: net worth with trend and a per-instrument market digest, your cash accounts one per row, this month's buys and sells from the operations register, the asset-class mix, your unrealized gain with the best and worst positions, and the instruments table — still a real management table with column sorting (Valore, G/P, Peso, Nome, Classe and the three Δ), a group-by-class toggle, the ticker under each name — a bond adds its maturity and next coupon («scade il 10/03/2032 · prossima cedola 10/12»), a hand-valued holding when its value was last typed — and an "Andamento" view that swaps Quantità · Prezzo · PMC · TER for the Δ month / YTD / since-start columns (both toggles are remembered). Those Δ columns measure the **unit price** of each position (in EUR, real estate gross of any mortgage), never its total value, so buying more of something never reads as performance; pension funds, properties and cash accounts, whose quantity *is* the value, show "—" and carry no G/P. Every delete is a two-click confirm without a timer, and deleting a cash account says in words what is lost before the second press. On the phone the instruments are flat rows that expand in place on the details, the price trend and the actions
