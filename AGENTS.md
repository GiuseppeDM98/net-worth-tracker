...
**Gotcha**: `formatCurrency` exists in BOTH `lib/utils/formatters.ts` AND `lib/services/chartService.ts`. Update both when modifying.
...
**Last updated**: 2026-03-19 (session: /clarify + /normalize — design tokens, copy consistency)
