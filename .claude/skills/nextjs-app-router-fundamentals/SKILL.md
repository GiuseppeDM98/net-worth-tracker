...
â””â”€â”€ api/                   # Route handlers
    â””â”€â”€ hello/
        â””â”€â”€ route.ts       # API endpoint: /api/hello
```
...
app/
â”œâ”€â”€ blog/
â”‚   â”œâ”€â”€ layout.tsx   # NOT a route
â”‚   â””â”€â”€ page.tsx     # This makes /blog accessible
```
...
**âŒ Wrong: Using Pages Router pattern**
```typescript
...
**âŒ Wrong: Missing export keyword**
```typescript
...
**âœ… Correct: Clean Server Component**
```typescript
// app/blog/[id]/page.tsx
